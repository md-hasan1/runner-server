...
import otpEmailSender from "../../../shared/otpSender";
// user login test to 
const loginUser = async (payload: {
  ...
  return { token: accessToken, role: userData.role, userId: userData.id , isCompleted: userData.isCompleted};
};
...
<div style="font-family: Arial, sans-serif; color: #333; padding: 30px; background: linear-gradient(135deg, #6c63ff, #3f51b5); border-radius: 8px;">
  ...
  await otpEmailSender(userData.email, html, "Forgot Password OTP");
